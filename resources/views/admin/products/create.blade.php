                        ...
                        <div class="row">
                            {!! Form::open(['route' => 'products.store', 'method' => 'POST', 'files' =>true]) !!}
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-2 col-form-label">Nombre</label>
                                    <div class="col-10">
                                    {!! Form::text('name2',null,['class'=>'form-control', 'placeholder'=>'Nombre del producto', 'require']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-text-input" class="col-2 col-form-label">Descripción</label>
                                    <div class="col-10">
                                    {!! Form::textarea('description',null,['class'=>'form-control trumbo', 'placeholder'=>'Descripción del producto', 'require']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-2 col-form-label">Descripción</label>
                                    <div class="col-10">
                                    {!! Form::textarea('description2',null,['class'=>'form-control trumbo', 'placeholder'=>'Descripción del producto', 'require']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
